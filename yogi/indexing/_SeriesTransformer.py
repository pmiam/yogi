"""
SeriesTransformer adapted from `sklearn.compose._column_transformer`
module by Andreas Mueller and Joris Van den Bossche

It is meant to aid in applying scikitlearn estimators directly to
pandas dataframes, thereby keeping pandas query and metadata
context available throughout exploratory model development
"""
